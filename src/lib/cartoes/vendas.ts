...
// Listagem crua de vendas por adquirente/dia (data da venda), sem comparar
// com extrato — serve pra conferir se o arquivo foi lido certo (a mesma
// pergunta que "Vamos pra Sul" levantava, mas sem misturar com a
